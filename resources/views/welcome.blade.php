...
<head>
    ...
    <link href="{{asset('homepage/css/business-frontpage.css')}}" rel="stylesheet">
    ...
    <nav class="navbar navbar-expand-lg navbar-dark bg-dark fixed-top">
        <div class="container">
        <a class="navbar-brand" href="#">Universitas Babe Mulia</a>
    ...
    <header class="bg-primary py-5 mb-5">
        ...
        <div class="row h-100 align-items-center">
            <div class="col-lg-12">
            <h1 class="display-4 text-white mt-5 mb-2">Perguruan Tinggi Swasta Terakreditasi</h1>

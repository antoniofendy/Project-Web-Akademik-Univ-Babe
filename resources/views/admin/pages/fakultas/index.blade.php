...
@section('konten')
    ...
    <a href="{{url( $BaseUrl . 'data/fakultas/create')}}" class="btn btn-primary mb-3"><i class="fas fa-plus"> Tambah Fakultas</i></a>
    
    <div class="row">
        <div class="col-12">
            <div class="card">
                <div class="card-header">
                    <h3 class="card-title">Data Seluruh Fakultas</h3>
                </div>
                <!-- /.card-header -->
                <div class="card-body">

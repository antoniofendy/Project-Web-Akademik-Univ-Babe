                        ...
                        <div class="row">
                            <div class="col-lg-8 col-md-12 mb-3">
                                ...
                                <div class="form-group">
                                    ...
                                    <select class="form-control" name="jurusan_id" class="jurusan_id" disabled>
                                        <option disabled selected>-Pilih Jurusan-</option>
                                        @foreach ($jurusan as $item)
                                            @if ($item->id == $mata_kuliah->jurusan_id)
                                                <option value="{{$item->nama_jurusan}}" selected>{{$item->nama_jurusan}}</option>
                                            @else
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" name="nama_matkul" class="form-control nama_matkul" placeholder="Nama Mata Kuliah" value="{{$mata_kuliah->nama_matkul}}" disabled>
                                </div>
                                <div class="form-group">
                                    <label for="name">Semester</label>
                                    <input type="number" name="semester" max="8" min="1" class="form-control semester" placeholder="Semester" value="{{$mata_kuliah->semester}}" disabled>
                                </div>
                                <div class="form-group">
                                    <label for="name">SKS Mata Kuliah</label>
                                    <input type="text" name="sks_matkul" class="form-control sks" placeholder="SKS Mata Kuliah" value="{{$mata_kuliah->sks_matkul}}" disabled>
                                </div>
                            ...
                            <div class="col-md-4 col-sm-12">
                                <div class="kode-mata-kuliah">
                                    ...
                                    <div class="form-group">
                                        <input type="text" name="id" class="form-control kode" value="{{$mata_kuliah->id}}" readonly>
                                    </div>
                                </div>
                            </div>
                        </div>
